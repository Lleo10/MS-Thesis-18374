''' After removing dimer remove all its components (xd,yd,zd,vxd,vyd,vzd,etc)'''
...
for q in Nd_arr:
    q = int(q)
    new_path = r'/home/sps_lab/Documents/nishant/n500_nd'+str(q)+'_ndg'+str(Nd_g)+'_ts'+str(timesteps/1000000)+'M_rd'+str(rate_d/1000)+'k_ra'+str(rate_a/1000)+'k.xyz'
    file = open(new_path, 'w')
    file.close()
    
    
    def intialize_pos(x,y,z,N):
        pathx = r'/home/sps_lab/Documents/nishant/x_eqbm.csv'
        pathy = r'/home/sps_lab/Documents/nishant/y_eqbm.csv'
        pathz = r'/home/sps_lab/Documents/nishant/z_eqbm.csv'
        filex = open(pathx)
        filey = open(pathy)
        filez = open(pathz)
